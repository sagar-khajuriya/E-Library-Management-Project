			...
			<c:choose>
				<c:when test="${searchLibrarian ne null}">
					<table border="1" cellpadding="10px">
						...
						<tr>
							<td>${searchLibrarian.lid}</td>
							<td>${searchLibrarian.lname}</td>
							<td>${searchLibrarian.lmailid}</td>
							<td>${searchLibrarian.lcontactno}</td>
							<td>${searchLibrarian.lpassword}</td>
							<td>${searchLibrarian.lgender}</td>
						</tr>
					</table>
