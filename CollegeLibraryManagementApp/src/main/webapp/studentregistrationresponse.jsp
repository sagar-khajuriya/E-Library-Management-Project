...
<body>
	...
	<p
		style="margin-top: 100px; margin-left: 200px; background-color: black; border-radius: 12px; opacity: 0.7; border: 3px solid black; text-align: center; font-size: 20px; color: white;">
